...
public class Dinner extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txvUserName=(TextView)findViewById(R.id.txvDinnerUName);
        ...
        myList = (ExpandableListView) findViewById(R.id.myListDinner);
        //create the adapter by passing your ArrayList data
        listAdapter = new LunchAdaptor(Dinner.this, catogoryList);
        ...
        btnSubmit = (Button) findViewById(R.id.btnDinnerSubmit);
        ...
        btnShareOrder = (Button) findViewById(R.id.btnDinnerShareOrder);
    ...
    private ExpandableListView.OnChildClickListener myListItemClicked =  new ExpandableListView.OnChildClickListener() {
        ...
        public boolean onChildClick(ExpandableListView parent, View v,
            ...
            /*Toast.makeText(Dinner.this, "Clicked on Detail " + headerInfo.getName()
    ...
    private ExpandableListView.OnGroupClickListener myListGroupClicked =  new ExpandableListView.OnGroupClickListener() {
        ...
        public boolean onGroupClick(ExpandableListView parent, View v,
            ...
            HeaderInfo headerInfo = catogoryList.get(groupPosition);
            //display it or do something with it
            /*Toast.makeText(Dinner.this, "Child on Header " + headerInfo.getName(),
    ...
    private void getOrderDetails() {
        ...
        Toast.makeText(Dinner.this, ordermessage, Toast.LENGTH_SHORT).show();
    }
}
